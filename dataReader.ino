...
char auth[] = "057d7111c85542138c7dd7d6a3a543de";
...
//////////////////////////////////////////////////////////////////////////////////////////////
//LIST OF ALL MODE 1 PIDS THAT YOU ARE CAPABLE OF POLLING. NOT ALL WILL BE AVAILABLE TO YOU.//
//////////////////////////////////////////////////////////////////////////////////////////////
...
void publishValues() {
//    String StringRPM = String(ENGINE_RPM);
//	String StringENGINE_LOAD = String(ENGINE_LOAD);
	//Particle.publish("RPM", StringRPM, PRIVATE);
	//Particle.publish("Throttle", StringThrottle, PRIVATE);
//	Serial.println("I published shit");

//    Particle.publish("Miata", "{ \"1\": \"" + StringRPM + "\"," +
//       "\"2\": \"" + StringENGINE_LOAD + "\"," +
       //"\"3\": \"" + String(tempF) + "\"," +
       //"\"4\": \"" + String(light) + "\"," +
//       "\"k\": \"" + key + "\" }", 60, PRIVATE);
